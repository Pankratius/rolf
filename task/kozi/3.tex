...
\begin{document}
	...
	\parbox{10.6cm}{\setstretch{2.0} \centering{ \huge \textsf{Aufgabenserie 3 - Sommerspaß \\ %\textit{mit Tipps}
				}}%\\
...
%\textbf{Tipp 1:}
%\textit{Bei minimaler Abwurfgeschwindigkeit ist die Bahn spiegelsymmetrisch zur Mittelpunktsachse des Baumstamms, und berührt ihn an insgesamt zwei Punkten (Warum?). Welche Kriterien lassen sich daraus ableiten?}
%\\
%\textbf{Tipp 2:}
%\textit{Mit der Ungleichung vom arithmetischen und geometrischen Mittel kann man minimal und maximal mögliche Werte finden:}
%\begin{equation*}
